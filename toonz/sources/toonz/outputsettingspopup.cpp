...
- Camera settings\n- Project folder to be saved in\n- File format\n- File options\n- Resample Balance\n- Channel width");
  ...
  if (!isPreview) {
    //clapperboard
    ret = ret && connect(m_addBoard, SIGNAL(stateChanged(int)), this, SLOT(onAddBoardChecked(int)));
    ret = ret && connect(m_boardSettingsBtn, SIGNAL(clicked()), this, SLOT(onBoardSettingsBtnClicked()));
