...
DVAPI void toLinearRGB(TRasterP raster, double gamma, bool sourceIsPremultiplied = true);
DVAPI void tosRGB(TRasterP raster, double gamma, bool sourceIsPremultiplied = true);
