...
TPixelD toLinear(const TPixelD &pix, const double gamma) {
  return TPixelD(toLin<TPixelD, double>(pix.r, gamma), toLin<TPixelD, double>(pix.g, gamma),
                 toLin<TPixelD, double>(pix.b, gamma), pix.m);
}
TPixelF toLinear(const TPixelF &pix, const double gamma) {
  return TPixelF(toLin<TPixelF, float>(pix.r, gamma), toLin<TPixelF, float>(pix.g, gamma),
