...
extern "C" {
TOONZ_EXPORT void toonz_plugin_probe(toonz_plugin_probe_t **begin,
                                     toonz_plugin_probe_t **end);
...
param_desc_t params1_[] = {
    param_desc_ctor<traits_color_t>("p1st", "color",
                                    {0, 0, 255 /* blue */, 255}),
...
toonz_param_group_t groups0_[] = {
    param_group_ctor("Group", sizeof(params0_) / sizeof(param_desc_t),
                     params0_),
};

toonz_param_group_t groups1_[] = {
    param_group_ctor("Group", sizeof(params1_) / sizeof(param_desc_t),
                     params1_),
};

toonz_param_page_t pages0_[] = {
    param_page_ctor("1st plugin",
                    sizeof(groups0_) / sizeof(toonz_param_group_t), groups0_),
};

toonz_param_page_t pages1_[] = {
    param_page_ctor("2nd plugin",
                    sizeof(groups1_) / sizeof(toonz_param_group_t), groups1_),
};
...
TOONZ_PLUGIN_PROBE_DEFINE(TOONZ_PLUGIN_VER(1, 0), "multi1-plugin" /* name */,
                          "dwango" /* vendor */,
                          "multi1.plugin" /* identifier */,
                          "1st plugin from the single module",
                          "http://dwango.co.jp/",
                          TOONZ_PLUGIN_CLASS_POSTPROCESS_SLAB |
                              TOONZ_PLUGIN_CLASS_MODIFIER_GEOMETRIC,
                          &toonz_plugin_node_handler0)
, TOONZ_PLUGIN_PROBE_DEFINE(TOONZ_PLUGIN_VER(1, 0), "multi2-plugin" /* name */,
                            "dwango" /* vendor */,
                            "multi2.plugin" /* identifier */,
                            "2nd plugin from the single module",
                            "http://dwango.co.jp/",
                            TOONZ_PLUGIN_CLASS_POSTPROCESS_SLAB |
                                TOONZ_PLUGIN_CLASS_MODIFIER_GEOMETRIC,
                            &toonz_plugin_node_handler1) TOONZ_PLUGIN_PROBE_END;
}
